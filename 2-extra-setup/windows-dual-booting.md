...
The issue with that, is that your bootloader entry for GRUB in your BIOS may be removed afterwards (depends on the BIOS). See the [Can't boot into Void Linux](../4-notes-troubleshooting/cant-boot-into-void-linux.md) page for help with restoring it.
