...
This is just like the [Installing the graphics driver](../1-installation/20-desktop-environment-setup.md#installing-the-graphics-driver) section of the desktop environment setup, but this time we're dealing with 32-bit package names.
